"""Scrape Wall Lights from Akeneo into Product Closeup w/ Description Table.

Table ID: tblYqudlgjYMNRROM
...
Usage:
    ...
    python "Product Closeup Description Story/3_Scrape_Akeneo_Wall_Lights.py"

    # Scrape N products (N rows):
    python "Product Closeup Description Story/3_Scrape_Akeneo_Wall_Lights.py" --count 3

    # Override Style or Table ID:
    python "Product Closeup Description Story/3_Scrape_Akeneo_Wall_Lights.py" --style modern --table-id tblYqudlgjYMNRROM
"""
...
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_WALL_LIGHTS_PRODUCT_DESCRIPTION", "").strip() or "tblYqudlgjYMNRROM"
