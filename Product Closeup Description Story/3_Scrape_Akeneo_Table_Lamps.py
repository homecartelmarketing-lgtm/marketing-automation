"""Scrape Table Lamps from Akeneo into Product Closeup w/ Description Table.

Table ID: tbl5S9JEHSrjrLwxA
...
Usage:
    ...
    python "Product Closeup Description Story/3_Scrape_Akeneo_Table_Lamps.py"

    # Scrape N products (N rows):
    python "Product Closeup Description Story/3_Scrape_Akeneo_Table_Lamps.py" --count 3

    # Override Style or Table ID:
    python "Product Closeup Description Story/3_Scrape_Akeneo_Table_Lamps.py" --style modern --table-id tbl5S9JEHSrjrLwxA
"""
...
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_TABLE_LAMPS_PRODUCT_DESCRIPTION", "").strip() or "tbl5S9JEHSrjrLwxA"
