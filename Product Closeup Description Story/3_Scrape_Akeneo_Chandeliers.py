"""Scrape Chandeliers from Akeneo into Product Closeup w/ Description Table.

Table ID: tblDcT6jovdAbKnfw
...
Usage:
    ...
    python "Product Closeup Description Story/3_Scrape_Akeneo_Chandeliers.py"

    # Scrape N products (N rows):
    python "Product Closeup Description Story/3_Scrape_Akeneo_Chandeliers.py" --count 3

    # Override Style or Table ID:
    python "Product Closeup Description Story/3_Scrape_Akeneo_Chandeliers.py" --style modern --table-id tblDcT6jovdAbKnfw
"""
...
LABEL = "Chandeliers Product Closeup w/ Description"
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_CHANDELIER_PRODUCT_DESCRIPTION", "").strip() or "tblDcT6jovdAbKnfw"
