"""Scrape Floor Lamps from Akeneo into Product Closeup w/ Description Table.

Table ID: tblPvHyKGByWJCMtY
...
Usage:
    ...
    python "Product Closeup Description Story/3_Scrape_Akeneo_Floor_Lamps.py"

    # Scrape N products (N rows):
    python "Product Closeup Description Story/3_Scrape_Akeneo_Floor_Lamps.py" --count 3

    # Override Style or Table ID:
    python "Product Closeup Description Story/3_Scrape_Akeneo_Floor_Lamps.py" --style modern --table-id tblPvHyKGByWJCMtY
"""
...
LABEL = "Floor Lamps Product Closeup w/ Description"
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_FLOOR_LAMP_PRODUCT_DESCRIPTION", "").strip() or "tblPvHyKGByWJCMtY"
