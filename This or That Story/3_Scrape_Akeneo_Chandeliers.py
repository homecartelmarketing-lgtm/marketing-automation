"""Scrape Chandeliers from Akeneo into This or That Story Table.

Table ID: tblo42IkuhYLIQBzk
Category: Chandeliers (Modern)
Row Capacity: 2 Products per Row + This or That Layout Watermark

Usage:
    # Scrape 1 pair (1 row = 2 products):
    python "This or That Story/3_Scrape_Akeneo_Chandeliers.py"

    # Scrape N pairs (N rows):
    python "This or That Story/3_Scrape_Akeneo_Chandeliers.py" --rows 3

    # Override Style or Table ID:
    python "This or That Story/3_Scrape_Akeneo_Chandeliers.py" --style modern --table-id tblo42IkuhYLIQBzk
"""
...
LABEL = "Chandeliers This or That"
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_CHANDELIERS_THIS_OR_THAT", "").strip() or "tblo42IkuhYLIQBzk"
