"""Scrape Pendant Lights from Akeneo into This or That Story Table.

Table ID: tblS1VHp41RDfxztD
...
Usage:
    ...
    python "This or That Story/3_Scrape_Akeneo_Pendant_Lights.py"

    # Scrape N pairs (N rows):
    python "This or That Story/3_Scrape_Akeneo_Pendant_Lights.py" --rows 3

    # Override Style or Table ID:
    python "This or That Story/3_Scrape_Akeneo_Pendant_Lights.py" --style modern --table-id tblS1VHp41RDfxztD
"""
...
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_PENDANT_LIGHTS_THIS_OR_THAT", "").strip() or "tblS1VHp41RDfxztD"
