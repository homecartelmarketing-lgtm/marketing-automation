"""Scrape Cluster Chandeliers from Akeneo into This or That Story Table.

Table ID: tblYAhjKckXtjUayx
...
Usage:
    ...
    python "This or That Story/3_Scrape_Akeneo_Cluster_Chandeliers.py"

    # Scrape N pairs (N rows):
    python "This or That Story/3_Scrape_Akeneo_Cluster_Chandeliers.py" --rows 3

    # Override Style or Table ID:
    python "This or That Story/3_Scrape_Akeneo_Cluster_Chandeliers.py" --style modern --table-id tblYAhjKckXtjUayx
"""
...
LABEL = "Cluster Chandeliers This or That"
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_CLUSTER_CHANDELIER_THIS_OR_THAT", "").strip() or "tblYAhjKckXtjUayx"
