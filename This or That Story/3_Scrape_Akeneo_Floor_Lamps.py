"""Scrape Floor Lamps from Akeneo into This or That Story Table.

Table ID: tblaoqj8VPVHFmVQn
Category: Floor Lamps (Modern)
Row Capacity: 2 Products per Row + This or That Layout Watermark

Usage:
    # Scrape 1 pair (1 row = 2 products):
    python "This or That Story/3_Scrape_Akeneo_Floor_Lamps.py"

    # Scrape N pairs (N rows):
    python "This or That Story/3_Scrape_Akeneo_Floor_Lamps.py" --rows 3

    # Override Style or Table ID:
    python "This or That Story/3_Scrape_Akeneo_Floor_Lamps.py" --style modern --table-id tblaoqj8VPVHFmVQn
"""
...
LABEL = "Floor Lamps This or That"
DEFAULT_TABLE_ID = os.getenv("AIRTABLE_TABLE_ID_FLOOR_LAMP_THIS_OR_THAT", "").strip() or "tblaoqj8VPVHFmVQn"
