...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Phase 0** | **Akeneo Scraper** | Akeneo PIM API | Active Ingestion (`enabled=true`) + cross-table dedup | Akeneo Catalog (`chandeliers`, `floor_lamps`) | `Furniture Item`, `Item Name`, `SKU` -> Status: `Pending` (`P`) |
