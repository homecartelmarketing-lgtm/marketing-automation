...
REEL_TABLES: dict[str, dict[str, Any]] = {
    "chandeliers": {
        ...
        "aliases": ["1", "chandeliers", "chandelier", "tblomhconggdwfs2y", "tblodnfanvp6sxn0a"],
    },
    "floor_lamps": {
        "table_code": "floor_lamps_day_night_reel",
        "label": "Floor Lamp Before and After Reel",
        "default_table_id": "tbl2VoWOt7sSut4E2",
        "env_table_key": "AIRTABLE_TABLE_ID_FLOORLAMP_DAY_AND_NIGHT_REEL",
        ...
        "placement_rule": "Place the floor lamp standing naturally and upright on the floor beside seating, sofa, or bed with soft contact floor shadows.",
        "aliases": ["2", "floor_lamps", "floor_lamp", "floor", "tbl2vowot7ssut4e2"],
    },
    "pendant_lights": {
        ...
        "aliases": ["3", "pendant_lights", "pendant_light", "pendant", "tbleup86kw36g8hdw"],
    },
}
